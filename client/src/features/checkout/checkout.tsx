...
import { clearBasket } from "../basket/data/basket-slice";
    ...
    const getStepContent = (step: number) => {
        switch (step) {
            ...
            case 1:
                return <Review />;
            case 2:
                return <PaymentForm cardState={cardState} onCardInputChange={handleCardInputChange} />;
            default:
    ...
    const submitOrder = async (data: FieldValues) => {
        ...
        try {
            ...
            if (paymentResult.paymentIntent?.status === "succeeded") {
                const orderNumber = await apiService.Orders.create({ saveAddress, shippingAddress });
